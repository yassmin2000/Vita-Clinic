...
export default function DoctorsTable() {
  ...
  const {
    ...
    queryKey: [
      `doctors_page_${currentPage}_count_${countPerPage}_gender_${currentGender}_sort_${sortBy}_search_${searchValue}`,
    ],
    queryFn: async () => {
      ...
      <div className="flex flex-col-reverse justify-between gap-2 sm:flex-row md:items-center">
        ...
        <div className="flex justify-between gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() => setCurrentPage((page) => page + 1)}
            disabled={(doctors && doctors.length < countPerPage) || isLoading}
          >
            Next
            <ArrowRight />
          </Button>
