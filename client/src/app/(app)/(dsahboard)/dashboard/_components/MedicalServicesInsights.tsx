...
const columns = [
  ...
  {
    title: 'Most Common Therapies',
    field: 'therapies',
  },
  {
    title: 'Most Common Scans',
    field: 'scans',
  },
  {
    title: 'Most Common Laboratory Tests',
    field: 'laboratoryTests',
  },
] as const;

export default function MedicalServicesInsights() {
  ...
  const { data: chartData } = useQuery({
    queryKey: [`medical_services_insights`],
    queryFn: async () => {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/dashboards/insights/services`,
        {
          headers: {
