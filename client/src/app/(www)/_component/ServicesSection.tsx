        ...
        <div className="flex items-center justify-center">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              At Vita Clinic, we offer a wide range of oncology services
              including advanced diagnostics, personalized treatment plans, and
              supportive services to enhance patient outcomes and quality of
              life.
            </p>
            <div className="mt-8 grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-4">
              <Card className="border-gray-200 bg-white text-zinc-900">
              ...
              <Card className="border-gray-200 bg-white text-zinc-900">
                <CardContent className="p-4">
                  ...
                  <div className="mt-2.5">
                    Advanced imaging (PET, CT, MRI, X-rays) and on-site lab
                    tests ensure precise diagnostics and timely results.
                  </div>
                </CardContent>
              </Card>
              <Card className="border-gray-200 bg-white text-zinc-900">
              ...
              <Card className="border-gray-200 bg-white text-zinc-900">
                <CardContent className="p-4">
                  ...
                  <div className="mt-2.5">
                    ...
                    support, and rehabilitation to enhance patient well-being
                    and quality of life.
                  </div>
                </CardContent>
              </Card>
