        ...
        <div className="block items-center justify-between md:flex">
          <div className="w-full md:max-w-[60%]">
            ...
            <p className="mt-2 text-gray-600">
              At Vita Clinic, we provide exceptional oncology care with a focus
              on personalized treatment plans, advanced technology, and
              compassionate support. Our experienced team is dedicated to
