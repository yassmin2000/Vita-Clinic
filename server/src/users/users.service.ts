...
export class UsersService {
  ...
  async create(
    ...
    if (!verified) {
      await this.otp.create(newUser.id, 'email', newUser.firstName, newUser.email);
    }
  ...
  async resendEmailVerification(dto: ResendEmailVerificationDto) {
    ...
    await this.otp.create(user.id, 'email', user.firstName, user.email);
  ...
  async resendPhoneVerification(dto: ResendPhoneVerificationDto) {
    ...
    await this.otp.create(user.id, 'phone', user.firstName, user.email);
